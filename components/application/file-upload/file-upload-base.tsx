...
export const FileUploadDropZone = ({
    ...
    return (
        <div
            ...
            className={cx(
                "relative flex flex-col items-center gap-3 rounded-xl bg-content2 px-6 py-4 text-tertiary transition duration-100 ease-linear cursor-pointer hover:ring-2 hover:ring-primary",
        ...
        >
            ...
            <div className="flex flex-col gap-1 text-center">
                <div className="flex justify-center gap-1 text-center">
                    ...
                    />
                    <span className="text-sm font-medium text-secondary">Click to upload or drag and drop</span>
                </div>
...
export const FileListItemProgressBar = ({ name, size, progress, failed, type, fileIconVariant, onDelete, onRetry, className }: FileListItemProps) => {
    ...
    return (
        <motion.li
            layout="position"
            className={cx(
                "relative flex gap-3 rounded-xl bg-content2 p-4 transition-shadow duration-100 ease-linear",
...
export const FileListItemProgressFill = ({ name, size, progress, failed, type, fileIconVariant, onDelete, onRetry, className }: FileListItemProps) => {
    ...
    return (
        <motion.li layout="position" className={cx("relative flex gap-3 overflow-hidden rounded-xl bg-primary p-4", className)}>
            ...
            <div
                className={cx(
                    "absolute inset-0 size-full rounded-[inherit] transition duration-100 ease-linear",
                    failed && "ring-2 ring-error",
                )}
            />
